  ...
  return (
    <main style={{
      ...
      <Section title="Agreement to Our Legal Terms">
        <p>We are CustomGuess (&quot;Company,&quot; &quot;we,&quot; &quot;us,&quot; &quot;our&quot;).</p>
        <p>We operate the website <a href="https://customguess.com" target="_blank" rel="noopener noreferrer" style={{ color: "var(--accent)" }}>https://customguess.com</a> (the &quot;<strong>Site</strong>&quot;), as well as any other related products and services that refer or link to these legal terms (the &quot;<strong>Legal Terms</strong>&quot;) (collectively, the &quot;<strong>Services</strong>&quot;).</p>
        <p>You can contact us by email at <a href="mailto:support@customguess.com" style={{ color: "var(--accent)" }}>support@customguess.com</a> or by mail to CustomGuess, Massachusetts, United States.</p>
        <p>These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity (&quot;<strong>you</strong>&quot;), and CustomGuess, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.</p>
      ...
      <Section title="Table of Contents">
        <nav style={{ display: "flex", flexDirection: "column", gap: "var(--s2)" }}>
          {[
            ...
            ["#prohibited", "5. Prohibited Activities"],
            ["#ugc", "6. User Generated Contributions"],
            ["#license", "7. Contribution License"],
            ["#reviews", "8. Guidelines for Reviews"],
            ["#sitemanage", "9. Services Management"],
            ["#ppno", "10. Privacy Policy"],
            ["#terms", "11. Term and Termination"],
            ["#modifications", "12. Modifications and Interruptions"],
            ["#law", "13. Governing Law"],
            ["#disputes", "14. Dispute Resolution"],
            ["#corrections", "15. Corrections"],
            ["#disclaimer", "16. Disclaimer"],
            ["#liability", "17. Limitations of Liability"],
            ["#indemnification", "18. Indemnification"],
            ["#userdata", "19. User Data"],
            ["#electronic", "20. Electronic Communications, Transactions, and Signatures"],
            ["#california", "21. California Users and Residents"],
            ["#misc", "22. Miscellaneous"],
            ["#contact", "23. Contact Us"],
          ].map(([href, label]) => (
            <a key={href} href={href} style={{ color: "var(--accent)", fontSize: "var(--text-sm)" }}>{label}</a>
          ))}
        </nav>
      </Section>
      ...
      <Section id="ip" title="2. Intellectual Property Rights">
        ...
        <SubSection title="Your use of our Services">
          <p>Subject to your compliance with these Legal Terms, including the &quot;<a href="#prohibited" style={{ color: "var(--accent)" }}>PROHIBITED ACTIVITIES</a>&quot; section below, we grant you a non-exclusive, non-transferable, revocable license to:</p>
          ...
          <p>If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: <a href="mailto:support@customguess.com" style={{ color: "var(--accent)" }}>support@customguess.com</a>. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.</p>
          <p>We reserve all rights not expressly granted to you in and to the Services, Content, and Marks.</p>
          <p>Any breach of these Intellectual Property Rights will constitute a material breach of our Legal Terms and your right to use our Services will terminate immediately.</p>
        </SubSection>
        <SubSection title="Your submissions and contributions">
          <p>Please review this section and the &quot;<a href="#prohibited" style={{ color: "var(--accent)" }}>PROHIBITED ACTIVITIES</a>&quot; section carefully prior to using our Services to understand the (a) rights you give us and (b) obligations you have when you post or upload any content through the Services.</p>
          ...
          <ul style={{ paddingLeft: "var(--s5)", display: "flex", flexDirection: "column", gap: "var(--s2)" }}>
            <li>confirm that you have read and agree with our &quot;<a href="#prohibited" style={{ color: "var(--accent)" }}>PROHIBITED ACTIVITIES</a>&quot; and will not post, send, publish, upload, or transmit through the Services any Submission nor post any Contribution that is illegal, harassing, hateful, harmful, defamatory, obscene, bullying, abusive, discriminatory, threatening to any person or group, sexually explicit, false, inaccurate, deceitful, or misleading;</li>
      ...
      <Section id="ugc" title="6. User Generated Contributions">
      ...
      <Section id="license" title="7. Contribution License">
      ...
      <Section id="reviews" title="8. Guidelines for Reviews">
      ...
      <Section id="ppno" title="10. Privacy Policy">
      ...
      <Section id="terms" title="11. Term and Termination">
      ...
      <Section id="modifications" title="12. Modifications and Interruptions">
      ...
      <Section id="law" title="13. Governing Law">
        <p>These Legal Terms and your use of the Services are governed by and construed in accordance with the laws of the Commonwealth of Massachusetts applicable to agreements made and to be entirely performed within the Commonwealth of Massachusetts, without regard to its conflict of law principles.</p>
      </Section>
      ...
      <Section id="disputes" title="14. Dispute Resolution">
        ...
        <SubSection title="Binding Arbitration">
          <p>If the Parties are unable to resolve a Dispute through informal negotiations, the Dispute (except those Disputes expressly excluded below) will be finally and exclusively resolved by binding arbitration. YOU UNDERSTAND THAT WITHOUT THIS PROVISION, YOU WOULD HAVE THE RIGHT TO SUE IN COURT AND HAVE A JURY TRIAL. The arbitration shall be commenced and conducted under the Commercial Arbitration Rules of the American Arbitration Association (&quot;AAA&quot;) and, where appropriate, the AAA&apos;s Supplementary Procedures for Consumer Related Disputes (&quot;AAA Consumer Rules&quot;), both of which are available at the <a href="http://www.adr.org" target="_blank" rel="noopener noreferrer" style={{ color: "var(--accent)" }}>American Arbitration Association (AAA) website</a>. Your arbitration fees and your share of arbitrator compensation shall be governed by the AAA Consumer Rules and, where appropriate, limited by the AAA Consumer Rules. The arbitration may be conducted in person, through the submission of documents, by phone, or online. The arbitrator will make a decision in writing, but need not provide a statement of reasons unless requested by either Party. The arbitrator must follow applicable law, and any award may be challenged if the arbitrator fails to do so. Except where otherwise required by the applicable AAA rules or applicable law, the arbitration will take place in Massachusetts, United States of America. Except as otherwise provided herein, the Parties may litigate in court to compel arbitration, stay proceedings pending arbitration, or to confirm, modify, vacate, or enter judgment on the award entered by the arbitrator.</p>
          <p>If for any reason, a Dispute proceeds in court rather than arbitration, the Dispute shall be commenced or prosecuted in the state and federal courts located in Massachusetts, and the Parties hereby consent to, and waive all defenses of lack of personal jurisdiction, and forum non conveniens with respect to venue and jurisdiction in such state and federal courts. Application of the United Nations Convention on Contracts for the International Sale of Goods and the Uniform Computer Information Transaction Act (UCITA) are excluded from these Legal Terms.</p>
      ...
      <Section id="corrections" title="15. Corrections">
      ...
      <Section id="liability" title="17. Limitations of Liability">
      ...
      <Section id="userdata" title="19. User Data">
        <p>We will maintain certain data that you transmit to the Services for the purpose of managing the performance of the Services, as well as data relating to your use of the Services. Although we perform regular routine backups of data, you are solely responsible for all data that you transmit or that relates to any activity you have undertaken using the Services. You agree that we shall have no liability to you for any loss or corruption of any such data, and you hereby waive any right of action against us arising from any such loss or corruption of such data.</p>
      </Section>

      <Section id="electronic" title="20. Electronic Communications, Transactions, and Signatures">
      ...
      <Section id="california" title="21. California Users and Residents">
        <p>If any complaint with us is not satisfactorily resolved, you can contact the Complaint Assistance Unit of the Division of Consumer Services of the California Department of Consumer Affairs in writing at 1625 North Market Blvd., Suite N 112, Sacramento, California 95834 or by telephone at (800) 952-5210 or (916) 445-1254.</p>
      </Section>

      <Section id="misc" title="22. Miscellaneous">
      ...
      <Section id="contact" title="23. Contact Us">
        ...
        <div style={{ marginTop: "var(--s3)" }}>
          <strong>CustomGuess</strong><br />
          <a href="mailto:support@customguess.com" style={{ color: "var(--accent)" }}>support@customguess.com</a>
        </div>
      </Section>
      ...
      <div style={{
        ...
        <Link href="/" style={{ color: "var(--accent)", fontSize: "var(--text-sm)" }}>
          Back to home
        </Link>
        <p style={{ color: "var(--text-400)", fontSize: "var(--text-xs)", margin: 0 }}>
...
function Section({ id, title, children }) {
  return (
    <section id={id} style={{ marginBottom: "var(--s7)", scrollMarginTop: "var(--s6)" }}>
      <h2 style={{
        fontFamily: "'Fraunces', serif",
...
function SubSection({ title, children }) {
  return (
    <div style={{ marginTop: "var(--s2)" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "var(--s3)", color: "var(--text-600)", lineHeight: 1.7 }}>
        {children}
      </div>
    </div>
  );
